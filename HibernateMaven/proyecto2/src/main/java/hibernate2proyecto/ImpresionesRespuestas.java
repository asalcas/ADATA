...
public class ImpresionesRespuestas {
    ...
    public static void usuarioActualizado(Usuarios usuario) {
        System.out.println();
        System.out.println("--------------------------------------------------");
        System.out.println("-  ¡Resultados de la actualización del Usuario!  -");
        System.out.println("--------------------------------------------------");
        System.out.println("ID: " + usuario.getIdUsuario());
        System.out.println("Nombre: " + usuario.getNombre());
        System.out.println("Apellidos: " + usuario.getApellidos());
    ...
    public static void postActualizado(Post post) {
        ...
        System.out.println("---------------------------------------");
        System.out.println("-  ¡Resultados del Post actualizado!  -");
        System.out.println("---------------------------------------");
        System.out.println("ID del Post: " + post.getIdPost());
        System.out.println("ID del Usuario: " + post.getUsuario().getIdUsuario());
        System.out.println("Fecha de creación del Post: " + post.getCreated_at());
    ...
    public static void likeActualizado(Likes like) {
        System.out.println();
        System.out.println("---------------------------------------");
        System.out.println("-  ¡Resultados del Like actualizado!  -");
        System.out.println("---------------------------------------");
        System.out.println("ID del Like: " + like.getIdLike());
        System.out.println("ID del Usuario que dio el Like: " + like.getUsuario().getIdUsuario());
        System.out.println("ID del Post que tiene el Like: " + like.getPost().getIdPost());
